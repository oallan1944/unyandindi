...
//     Select, useMediaQuery, useTheme, Button
// } from '@mui/material'
// import { FilterAlt } from '@mui/icons-material'
// import { useAppDispatch, useAppSelector } from '../../../State/store'
// import { fetchAllProducts } from '../../../State/customer/ProductSlice'
...
//         const newFilter: any = { color, pageNumber }
//         if (minPrice !== undefined) newFilter.minPrice = minPrice
//         if (maxPrice !== undefined) newFilter.maxPrice = maxPrice
//         if (minDiscount !== undefined) newFilter.minDiscount = minDiscount
...
//     useEffect(() => {
//         loadProducts()
//     }, [dispatch, searchParams, page, category])

//     return (
//         <div className='-z-10 mt-10'>
//             <div>
//                 <h1 className='text-3xl text-center font-bold text-gray-700 pb-5 px-9 uppercase'>
//                     {category ? category.replace(/_/g, ' ') : 'Products'}
//                 </h1>
//             </div>
...
//                     {/* ── Product Grid with AsyncStateWrapper ── */}
//                     <ErrorBoundary>
//                         <AsyncStateWrapper
//                             loading={productState.product !== null && productState.loading}
//                             error={productState.error}
//                             empty={
//                                 !productState.loading &&
//                                 !productState.error &&
...
//                                 count={productState.totalPages || 10}
//                                 variant="outlined"
//                                 color='primary'
//                                 page={page}
//                             />
